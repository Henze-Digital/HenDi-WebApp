...
declare function query:get-author-element($doc as document-node()?) as element()* {
    ...
    then(($doc//mei:workList/mei:work[1]//(mei:persName|mei:corpName)[@role = ('cmp', 'aut', 'lbt', 'arr')] |
        ...
        $doc//mei:fileDesc/mei:titleStmt/mei:respStmt/(mei:persName|mei:corpName)[@role = ('cmp', 'aut', 'lbt', 'arr')] |
...
declare function query:get-main-source($doc as document-node()) as element()? {
    ...
    return
        if(count($sources) gt 1) then $sources/parent::tei:witness[@n='1']/* | $sources/parent::tei:listBibl/tei:*[1] | $sources/parent::tei:sourceDesc/*[1]
        else $sources
};
...
declare function query:text-sources($doc as document-node()) as element()* {
    ...
    let $source := 
        ...
        default return $doc//tei:sourceDesc/tei:*[not(self::tei:listRelation)]
    return 
        typeswitch($source)
...
declare function query:get-normalized-date($doc as document-node()) as xs:date? {
    ...
    let $date := 
        ...
        case 'letters' return hwh-util:getCastableDateTime(($doc//tei:correspAction[@type='sent']/tei:date, $doc//tei:correspAction[@type='received']/tei:date)[1], false())
