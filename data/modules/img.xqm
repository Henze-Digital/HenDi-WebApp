        ...
        map {
            ...
            'url' : function($size) {
                ...
                case 'thumb' case 'small' return 
                    ...
                    case 'm' return config:link-to-current-app('resources/img/icons/icon_person_male.scg')
                    ...
                    case 'longPlay' return config:link-to-current-app('resources/img/icons/icon_longPlay.svg')
